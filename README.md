...
To build an image for your platform, clone the repo, cd to **./PSI** run `npm install` and finally `npm run build` - rename **dist/server** to **server.psi**, and distrubute with your application.
