...
To build an image for your platform, clone the repo, cd to **./PSI** run `yarn install --immutable` and finally `yarn run build` - rename **dist/server** to **server.psi**, and distrubute with your application.
